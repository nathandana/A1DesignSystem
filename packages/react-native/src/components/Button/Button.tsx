...
export interface ButtonProps extends Omit<PressableProps, 'children' | 'style'> {
  ...
  size?: ButtonSize;
  children: string;
  /** Material icon name or custom icon element */
  icon?: IconSource;
...
export function Button({
  ...
  const styledIcon = icon ? renderMaterialIcon(icon as IconSource, sizeTokens.iconSize, variantTokens.foreground) : null;
    ...
    >
      ...
      >
        ...
        {icon && iconPosition === 'start' && !loading && (
          <View style={{ marginEnd: buttonTokens.gap }}>{styledIcon}</View>
        )}
        ...
        {icon && iconPosition === 'end' && !loading && (
          <View style={{ marginStart: buttonTokens.gap }}>{styledIcon}</View>
        )}
