...
export interface IconButtonProps extends Omit<PressableProps, 'children' | 'style'> {
  /**
   * Icon to render. Pass a Material icon name, a custom element, or a render function.
   */
  icon: IconRenderer;
...
export function IconButton({
  ...
  return (
    <Animated.View style={{ transform: [{ scale }], opacity: disabled ? buttonTokens.disabledOpacity : 1 }}>
      <Pressable
