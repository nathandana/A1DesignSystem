...
-- ─── Basic site-visit analytics ─────────────────────────────────────────────
-- Public browsers report a generated visit ID and current A1 route through a
-- Netlify Function. The function supplies the trusted client IP and is the only
-- writer; only the administrator-authenticated server function reads the data.
