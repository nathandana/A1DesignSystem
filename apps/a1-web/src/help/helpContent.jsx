/**
 * Canonical Help content for a1-web.
 *
 * Keep future Help articles in this module so the same source can power the
 * rendered Help page, search metadata, and AI-friendly plain-text exports.
 */
...
import { buildHelpAiCatalog, buildHelpCategories } from './helpModel.jsx'
...

  {
    ...
    articles: [
      ...
      },
      {
        ...
        keywords: 'ai icon finder material symbols custom icons describe suggest auto awesome configure icon button codex bridge tokens registry',
        body: (
          <Stack gap="sm">
            ...
            <Steps items={[
              ...
              'The local Codex bridge returns built-in Material Symbols and active-project custom icon options. A1 validates every returned name before showing it.',
          ...
          <Stack gap="sm">
            ...
            <DefinitionList
              ...
              items={[
                ...
                { label: 'Open Help assistant', value: '?' },
...
export const HELP_AI_CONTENT = buildHelpAiCatalog(HELP_CONTENT)
