...
- `system/ai/project-foundations.md` — repository structure, token flow, themes, labels, and shared system concepts.
- `system/ai/project-workflows.md` — CSS rules, component architecture, package-specific rules, and invariants.
...
- `system/ai/quick-orientation.md` — build commands and key file locations.
- `system/ai/a11y-policy.md` — accessibility check policy and commands.
...
1. Read `system/ai/project-foundations.md` for the system model: monorepo layout, token tiers, theme flow, label format, and supported breakpoints.
2. Read `system/ai/project-workflows.md` before editing CSS, components, examples, package code, or system rules.
3. Check `system/ai/components.md` before asking whether a component exists or where it is implemented.
4. Check `system/ai/quick-orientation.md` for build commands and key file locations.
5. Follow `system/ai/a11y-policy.md` for accessibility-relevant changes.
