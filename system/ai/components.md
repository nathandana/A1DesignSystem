...
| **Pure** | `packages/html-css/dist/a1-pure.css` — scoped HTML/CSS classes |
...
| Category | `components-typography` | Typography | `title` | Heading, Paragraph, Blockquote, List, Divider, Inline |
...
| Category | `components-data` | Data | `table` | Data Table, Pagination |
