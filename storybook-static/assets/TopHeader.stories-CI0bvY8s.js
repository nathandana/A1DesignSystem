import{i as e}from"./preload-helper-Cs4UwXAW.js";import{r as t}from"./iframe-DZoRqkgT.js";import{n,t as r}from"./TopHeader-CWgc4yeo.js";var i,a,o,s,c,l,u,d,f,p,m;e((()=>{n(),i=t(),a=[{id:`home`,label:`Home`,icon:`home`,iconOnly:!0,href:`/`,active:!0},{id:`products`,label:`Products`,icon:`inventory_2`,href:`/products`},{id:`analytics`,label:`Analytics`,icon:`analytics`,href:`/analytics`,items:[{label:`Overview`,href:`/analytics`},{divider:!0},{label:`Reports`,href:`/analytics/reports`,items:[{label:`Revenue`,href:`/analytics/reports/revenue`},{label:`Engagement`,href:`/analytics/reports/engagement`},{label:`Retention`,href:`/analytics/reports/retention`}]},{label:`Forecasting`,href:`/analytics/forecast`}]},{id:`docs`,label:`Documentation`,icon:`article`,href:`/docs`}],o=[{id:`notifications`,icon:`notifications`,label:`Notifications`,badge:3,items:[{isHeader:!0,label:`Notifications`},{divider:!0},{label:`New comment on Transform`,icon:`chat_bubble`,href:`#`},{label:`Build passed`,icon:`check_circle`,href:`#`},{label:`Review requested`,icon:`rate_review`,href:`#`},{divider:!0},{label:`See all notifications`,href:`#`}]},{id:`settings`,icon:`settings`,label:`Settings`,items:[{label:`Preferences`,icon:`settings`,href:`#`},{label:`Appearance`,icon:`palette`,href:`#`},{label:`API Keys`,icon:`key`,href:`#`}]},{id:`user`,icon:`account_circle`,label:`Account`,items:[{isHeader:!0,label:`Nathan Dana`,description:`nathan.dana@gmail.com`},{divider:!0},{label:`Profile`,icon:`person`,href:`#`},{label:`Switch account`,icon:`swap_horiz`,href:`#`},{divider:!0},{label:`Sign out`,icon:`logout`,danger:!0,onClick:()=>{}}]}],s=(0,i.jsx)(`div`,{style:{padding:`var(--base-spacing-40) var(--base-spacing-40)`,fontFamily:`var(--component-paragraph-font-family)`,fontSize:`var(--semantic-font-size-body-md)`,color:`var(--semantic-color-text-muted)`},children:`Page content`}),c={title:`Components/Navigation/TopHeader`,component:r,tags:[`autodocs`],parameters:{layout:`fullscreen`},argTypes:{logoText:{control:`text`},logoHref:{control:`text`},loginButton:{control:`boolean`,description:`Show login button`}}},l={name:`Default`,parameters:{controls:{include:[]}},render:()=>(0,i.jsxs)(`div`,{style:{background:`var(--semantic-color-surface-page)`,minHeight:300},children:[(0,i.jsx)(r,{logoText:`A1 Design`,logoHref:`#`,navItems:a,actions:o}),s]})},u={name:`With login button`,parameters:{controls:{include:[]}},render:()=>(0,i.jsxs)(`div`,{style:{background:`var(--semantic-color-surface-page)`,minHeight:300},children:[(0,i.jsx)(r,{logoText:`A1 Design`,logoHref:`#`,navItems:a,actions:[o[0]],loginButton:{label:`Log in`,onClick:()=>{}}}),s]})},d={name:`Nav items without icons`,parameters:{controls:{include:[]}},render:()=>(0,i.jsxs)(`div`,{style:{background:`var(--semantic-color-surface-page)`,minHeight:300},children:[(0,i.jsx)(r,{logoText:`Acme`,logoHref:`#`,navItems:[{id:`home`,label:`Home`,href:`/`,active:!0},{id:`products`,label:`Products`,href:`/products`},{id:`pricing`,label:`Pricing`,href:`/pricing`},{id:`company`,label:`Company`,items:[{label:`About us`,href:`/about`},{label:`Blog`,href:`/blog`},{label:`Careers`,href:`/careers`}]}],actions:o.slice(2)}),s]})},f={name:`Active item in secondary/tertiary menu`,parameters:{controls:{include:[]}},render:()=>(0,i.jsxs)(`div`,{style:{background:`var(--semantic-color-surface-page)`,minHeight:300},children:[(0,i.jsx)(r,{logoText:`A1 Design`,logoHref:`#`,navItems:[{id:`home`,label:`Home`,icon:`home`,iconOnly:!0,href:`/`},{id:`products`,label:`Products`,icon:`inventory_2`,href:`/products`},{id:`analytics`,label:`Analytics`,icon:`analytics`,href:`/analytics`,active:!0,items:[{label:`Overview`,href:`/analytics`},{divider:!0},{label:`Reports`,href:`/analytics/reports`,items:[{label:`Revenue`,href:`/analytics/reports/revenue`,active:!0},{label:`Engagement`,href:`/analytics/reports/engagement`},{label:`Retention`,href:`/analytics/reports/retention`}]},{label:`Forecasting`,href:`/analytics/forecast`}]},{id:`docs`,label:`Documentation`,icon:`article`,href:`/docs`}],actions:o}),s]})},p={name:`Custom logo node`,parameters:{controls:{include:[]}},render:()=>(0,i.jsxs)(`div`,{style:{background:`var(--semantic-color-surface-page)`,minHeight:300},children:[(0,i.jsx)(r,{logo:(0,i.jsxs)(`span`,{style:{fontWeight:900,fontSize:`var(--semantic-font-size-heading-sm)`,letterSpacing:`-0.02em`},children:[`A1`,(0,i.jsx)(`span`,{style:{color:`var(--semantic-color-text-accent)`},children:`.`})]}),logoHref:`#`,navItems:a,actions:o}),s]})},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  name: "Default",
  parameters: {
    controls: {
      include: []
  ...
  render: () => <div style={{
    ...
    minHeight: 300
      ...
      <TopHeader logoText="A1 Design" logoHref="#" navItems={[{
      id: "home",
      label: "Home",
      icon: "home",
      iconOnly: true,
      ...
      items: [{
        ...
        items: [{
          ...
          label: "Engagement",
          href: "/analytics/reports/engagement"
        }, {
          label: "Retention",
          href: "/analytics/reports/retention"
        }]
      }, {
        label: "Forecasting",
...
}`,...p.parameters?.docs?.source}}},m=[`Default`,`WithLoginButton`,`NoIcons`,`ActiveInSubmenu`,`LogoSlot`]}))();export{f as ActiveInSubmenu,l as Default,p as LogoSlot,d as NoIcons,u as WithLoginButton,m as __namedExportsOrder,c as default};