      ...
      <div>
        ...
        <List>
          <ListItem>
            Components
            <List size="sm">
              <ListItem>Button — primary, secondary, tertiary, destructive</ListItem>
              <ListItem>Icon Button — compact action trigger</ListItem>
              <ListItem>Link — inline and standalone variants</ListItem>
            </List>
          </ListItem>
          <ListItem>
            Foundations
            <List size="sm">
              <ListItem>Tokens — base, semantic, and component layers</ListItem>
              <ListItem>Motion — duration scale and named easing curves</ListItem>
              <ListItem>Typography — paragraph, heading, list</ListItem>
            </List>
          </ListItem>
          <ListItem>Rules and guidelines</ListItem>
        </List>
      </div>
...
}`,...O.parameters?.docs?.source}}},k=[`Configurable`,`SizeScale`,`Ordered`,`IconVariant`,`Wrapping`,`Nested`,`Mixed`,`Colors`]}))();export{O as Colors,x as Configurable,w as IconVariant,D as Mixed,E as Nested,C as Ordered,S as SizeScale,T as Wrapping,k as __namedExportsOrder,v as default};