import{i as e,s as t}from"./preload-helper-Cs4UwXAW.js";import{T as n,r}from"./iframe-DZoRqkgT.js";import{n as i,t as a}from"./IconButton-Btx-EITG.js";import{n as o,t as s}from"./Button-Clq9-j9U.js";import{r as c,t as l}from"./Heading-Cv0veVz5.js";import{n as u,t as d}from"./Link-JV1UW1fo.js";import{r as f,t as p}from"./Message-Ph28UWWh.js";import{n as m,t as h}from"./Paragraph-CcdcQtLu.js";var g,_=e((()=>{g=`component: Button
rules:
...
rules:
  ...
  - id: card-navigation-single-destination
    components:
      - Card
    requirement: Use navigation Cards only when the entire card represents one destination.
    do: Make the Card destination match the title and supporting content.
    dont: Use a navigation Card when different parts of the card imply different actions or destinations.
    applies_to:
      - usability
      - content
      - interaction
`})),b,x=e((()=>{b=`component: Badge
rules:
  ...
  - id: badge-screen-reader-meaning
    ...
    applies_to:
      - accessibility
      - semantics`})),S,C=e((()=>{S=`component: Motion
rules:
...
rules:
  - id: system-heading-sentence-case
    ...
    applies_to:
      ...
      - typography
      - consistency
  - id: system-no-font-weight-on-state
    components:
      - System
    requirement: Never change font-weight on interactive or selection states.
    do: Use color, border, background, or underline to communicate hover, active, focus, and selected states.
    dont: Apply a different font-weight on :hover, :active, :focus, [aria-selected="true"], [aria-current], or [aria-pressed] — this causes the element to resize, which can shift surrounding layout and cause reflow.
    applies_to:
      - css
      - interaction
      - typography
  ...
  - id: system-no-uppercase-content
    ...
    applies_to:
      ...
      - typography
      - accessibility
`}));function A(e,t){let n=e.split(`
`),r=j(n,`component`),i=M(n,`components`),a=[],o=null,s=null;for(let e of n){let t=e.trim();if(t.startsWith(`- id:`)){o={id:N(t),requirement:``,do:``,dont:``,applies_to:[]},a.push(o),s=null;continue}if(o){if(t.startsWith(`requirement:`)){o.requirement=N(t),s=null;continue}if(t.startsWith(`do:`)){o.do=N(t),s=null;continue}if(t.startsWith(`dont:`)){o.dont=N(t),s=null;continue}if(t.endsWith(`:`)){s=t.slice(0,-1),Array.isArray(o[s])||(o[s]=[]);continue}s&&t.startsWith(`- `)&&o[s].push(t.slice(2))}}return{filePath:t,components:i.length?i:[r].filter(Boolean),rules:a}}function j(e,t){let n=e.find(e=>!e.startsWith(` `)&&e.trim().startsWith(`${t}:`));return n?N(n.trim()):``}function M(e,t){let n=j(e,t);if(n.startsWith(`[`)&&n.endsWith(`]`))return n.slice(1,-1).split(`,`).map(e=>e.trim()).filter(Boolean);let r=[],i=e.findIndex(e=>!e.startsWith(` `)&&e.trim()===`${t}:`);if(i===-1)return r;for(let t of e.slice(i+1)){let e=t.trim();if(!t.startsWith(` `)||e.endsWith(`:`))break;e.startsWith(`- `)&&r.push(e.slice(2))}return r}function N(e){return e.slice(e.indexOf(`:`)+1).trim().replace(/^["']|["']$/g,``)}function P(e){return e.reduce((e,t)=>(t.rules.forEach(n=>{let r=n.components?.length?n.components:t.components;r.forEach(i=>{e[i]||(e[i]=[]),e[i].push({...n,components:r,filePath:t.filePath})})}),e),{})}function F({rule:e,componentName:t}){return e.id.startsWith(`system-`)?(0,U.jsx)(L,{rule:e}):e.id.startsWith(`badge-`)?(0,U.jsx)(R,{rule:e}):e.id.startsWith(`button-`)?t===`IconButton`?(0,U.jsx)(B,{rule:e}):(0,U.jsx)(z,{rule:e}):(0,U.jsxs)(`div`,{style:G.examples,children:[(0,U.jsxs)(`div`,{style:G.example,children:[(0,U.jsx)(I,{type:`do`}),(0,U.jsx)(h,{size:`sm`,children:e.do})]}),(0,U.jsxs)(`div`,{style:G.example,children:[(0,U.jsx)(I,{type:`dont`}),(0,U.jsx)(h,{size:`sm`,children:e.dont})]})]})}function I({type:e}){let t=e===`do`;return(0,U.jsx)(`div`,{style:G.exampleLabelWrap,children:(0,U.jsx)(p,{status:t?`success`:`error`,children:t?`Do`:`Don't`})})}function L({rule:e}){let t={"system-heading-sentence-case":{do:(0,U.jsx)(l,{as:`h2`,size:`md`,children:`Payment details`}),dont:(0,U.jsx)(l,{as:`h2`,size:`md`,children:`Payment Details`})},"system-no-uppercase-content":{do:(0,U.jsx)(l,{as:`h2`,size:`md`,children:`Submit form`}),dont:(0,U.jsx)(l,{as:`h2`,size:`md`,style:{textTransform:`uppercase`},children:`Submit form`})}}[e.id];return t?(0,U.jsxs)(`div`,{style:G.examples,children:[(0,U.jsxs)(`div`,{style:G.example,children:[(0,U.jsx)(I,{type:`do`}),t.do]}),(0,U.jsxs)(`div`,{style:G.example,children:[(0,U.jsx)(I,{type:`dont`}),t.dont]})]}):null}function R({rule:e}){let t={"badge-natural-width":{do:(0,U.jsx)(p,{status:`success`,children:`Active`}),dont:(0,U.jsx)(`div`,{className:`a1-rule-demo-badge-fill`,style:G.demoRail,children:(0,U.jsx)(p,{status:`success`,children:`Active`})})},"badge-short-label":{do:(0,U.jsx)(p,{status:`info`,children:`Beta`}),dont:(0,U.jsx)(p,{status:`info`,children:`This feature is currently in beta testing`})},"badge-status-clarity":{do:(0,U.jsx)(p,{status:`warn`,children:`Pending`}),dont:(0,U.jsx)(p,{status:`info`,children:`Open settings`})},"badge-not-actionable-by-default":{do:(0,U.jsx)(s,{variant:`secondary`,children:`Filter by status`}),dont:(0,U.jsx)(p,{status:`info`,className:`a1-rule-demo-clickable-badge`,children:`Filter`})},"badge-color-not-alone":{do:(0,U.jsx)(p,{status:`error`,children:`Error`}),dont:(0,U.jsx)(p,{status:`error`,"aria-label":`Status`,className:`a1-rule-demo-color-only-badge`,children:` `})},"badge-accessible-contrast":{do:(0,U.jsx)(p,{status:`success`,children:`Success`}),dont:(0,U.jsx)(p,{status:`success`,className:`a1-rule-demo-low-contrast-badge`,children:`Success`})},"badge-consistent-meaning":{do:(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(p,{status:`success`,children:`Approved`}),(0,U.jsx)(p,{status:`error`,children:`Failed`})]}),dont:(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(p,{status:`success`,children:`Approved`}),(0,U.jsx)(p,{status:`success`,children:`Failed`})]})},"badge-semantic-variant-before-custom":{do:(0,U.jsx)(p,{status:`info`,children:`Info`}),dont:(0,U.jsx)(p,{status:`info`,className:`a1-rule-demo-custom-badge`,children:`Launch`})},"badge-icon-supportive":{do:(0,U.jsx)(p,{status:`success`,icon:`check_circle`,children:`Verified`}),dont:(0,U.jsx)(p,{status:`neutral`,icon:`star`,children:`Draft`})},"badge-icon-not-required-for-status":{do:(0,U.jsx)(p,{status:`warn`,icon:`warning`,children:`Past due`}),dont:(0,U.jsx)(p,{status:`warn`,icon:`warning`,"aria-label":`Past due`,children:` `})},"badge-readable-type-size":{do:(0,U.jsx)(p,{status:`neutral`,children:`Draft`}),dont:(0,U.jsx)(p,{status:`neutral`,className:`a1-rule-demo-tiny-badge`,children:`Draft`})},"badge-stable-height":{do:(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(p,{status:`neutral`,children:`Draft`}),(0,U.jsx)(p,{status:`success`,children:`Active`})]}),dont:(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(p,{status:`neutral`,children:`Draft`}),(0,U.jsx)(p,{status:`success`,className:`a1-rule-demo-tall-badge`,children:`Active`})]})},"badge-appropriate-density":{do:(0,U.jsx)(p,{status:`neutral`,className:`a1-rule-demo-compact-badge`,children:`New`}),dont:(0,U.jsx)(p,{status:`neutral`,className:`a1-rule-demo-oversized-badge`,children:`New`})},"badge-inline-alignment":{do:(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(`span`,{style:G.demoText,children:`Plan`}),(0,U.jsx)(p,{status:`info`,children:`Beta`})]}),dont:(0,U.jsxs)(`div`,{style:{...G.demoRow,justifyContent:`space-between`,width:`100%`},children:[(0,U.jsx)(`span`,{style:G.demoText,children:`Plan`}),(0,U.jsx)(p,{status:`info`,children:`Beta`})]})},"badge-count-formatting":{do:(0,U.jsx)(p,{status:`neutral`,icon:`notifications`,children:`99+`}),dont:(0,U.jsx)(p,{status:`neutral`,icon:`notifications`,children:`123456789`})},"badge-overuse-avoidance":{do:(0,U.jsx)(p,{status:`warn`,children:`Past due`}),dont:(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(p,{status:`neutral`,children:`New`}),(0,U.jsx)(p,{status:`info`,children:`Beta`}),(0,U.jsx)(p,{status:`success`,children:`Active`}),(0,U.jsx)(p,{status:`warn`,children:`Soon`})]})},"badge-theme-support":{do:(0,U.jsx)(p,{status:`success`,children:`Theme token`}),dont:(0,U.jsx)(p,{status:`success`,className:`a1-rule-demo-hardcoded-badge`,children:`Hard-coded`})},"badge-truncation-rules":{do:(0,U.jsx)(p,{status:`info`,children:`Optional`}),dont:(0,U.jsx)(p,{status:`info`,children:`Optional for enterprise administrators only`})},"badge-localization-support":{do:(0,U.jsx)(p,{status:`info`,children:`In review`}),dont:(0,U.jsx)(p,{status:`info`,className:`a1-rule-demo-fixed-badge`,children:`Ausstehende Genehmigung`})},"badge-screen-reader-meaning":{do:(0,U.jsx)(p,{status:`error`,children:`Payment failed`}),dont:(0,U.jsx)(p,{status:`error`,"aria-label":`Red status`,children:`!`})}}[e.id];return t?(0,U.jsxs)(`div`,{style:G.examples,children:[(0,U.jsx)(`style`,{children:`
        ...
        `}),(0,U.jsxs)(`div`,{style:G.example,children:[(0,U.jsx)(I,{type:`do`}),t.do]}),(0,U.jsxs)(`div`,{style:G.example,children:[(0,U.jsx)(I,{type:`dont`}),t.dont]})]}):null}function z({rule:e}){let t={"button-clear-action-label":{do:(0,U.jsx)(s,{children:`Save changes`}),dont:(0,U.jsx)(s,{children:`Submit`})},"button-visual-hierarchy":{do:(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(s,{children:`Save changes`}),(0,U.jsx)(s,{variant:`secondary`,children:`Preview`}),(0,U.jsx)(s,{variant:`tertiary`,children:`Cancel`})]}),dont:(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(s,{children:`Save`}),(0,U.jsx)(s,{children:`Preview`}),(0,U.jsx)(s,{children:`Cancel`})]})},"button-single-primary-action":{do:(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(s,{children:`Publish`}),(0,U.jsx)(s,{variant:`secondary`,children:`Save draft`}),(0,U.jsx)(s,{variant:`tertiary`,children:`Cancel`})]}),dont:(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(s,{children:`Publish`}),(0,U.jsx)(s,{children:`Save draft`}),(0,U.jsx)(s,{children:`Schedule`})]})},"button-not-color-alone":{do:(0,U.jsx)(s,{variant:`destructive`,icon:`delete`,children:`Delete project`}),dont:(0,U.jsx)(s,{className:`a1-rule-demo-red-only`,children:`Project`})},"button-destructive-clarity":{do:(0,U.jsx)(s,{variant:`destructive`,icon:`delete`,children:`Delete project`}),dont:(0,U.jsx)(s,{variant:`destructive`,children:`Confirm`})},"button-appropriate-visual-weight":{do:(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(s,{children:`Invite member`}),(0,U.jsx)(s,{variant:`tertiary`,children:`Remove member`})]}),dont:(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(s,{children:`Remove member`}),(0,U.jsx)(s,{variant:`secondary`,children:`Invite member`})]})},"button-short-specific-labels":{do:(0,U.jsx)(s,{children:`Download report`}),dont:(0,U.jsx)(s,{children:`Click here to download the full monthly performance report`})},"button-verb-first-labels":{do:(0,U.jsx)(s,{children:`Edit profile`}),dont:(0,U.jsx)(s,{children:`Profile`})},"button-icon-and-verb":{do:(0,U.jsx)(s,{variant:`tertiary`,icon:`settings`,children:`Edit settings`}),dont:(0,U.jsx)(s,{variant:`tertiary`,children:`Edit settings`})},"button-consistent-placement":{do:(0,U.jsxs)(`div`,{style:G.demoColumn,children:[(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(s,{variant:`tertiary`,children:`Cancel`}),(0,U.jsx)(s,{children:`Save changes`})]}),(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(s,{variant:`tertiary`,children:`Cancel`}),(0,U.jsx)(s,{children:`Create account`})]})]}),dont:(0,U.jsxs)(`div`,{style:G.demoColumn,children:[(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(s,{variant:`tertiary`,children:`Cancel`}),(0,U.jsx)(s,{children:`Save changes`})]}),(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(s,{children:`Create account`}),(0,U.jsx)(s,{variant:`tertiary`,children:`Cancel`})]})]})},"button-align-with-content":{do:(0,U.jsxs)(`div`,{style:G.demoColumn,children:[(0,U.jsx)(`p`,{style:G.demoText,children:`Project details`}),(0,U.jsx)(s,{children:`Edit project`})]}),dont:(0,U.jsxs)(`div`,{style:{...G.demoRail,display:`flex`,flexDirection:`column`,alignItems:`center`,gap:`var(--base-spacing-8)`},children:[(0,U.jsx)(`p`,{style:{...G.demoText,alignSelf:`stretch`},children:`Project details`}),(0,U.jsx)(s,{children:`Edit project`})]})},"button-center-alignment-context":{do:(0,U.jsxs)(`div`,{style:{...G.demoColumn,alignItems:`center`,textAlign:`center`},children:[(0,U.jsx)(`p`,{style:G.demoText,children:`No reports yet`}),(0,U.jsx)(s,{children:`Create report`})]}),dont:(0,U.jsxs)(`div`,{style:G.demoColumn,children:[(0,U.jsx)(`p`,{style:G.demoText,children:`Reports`}),(0,U.jsx)(`div`,{style:{...G.demoRail,display:`flex`,justifyContent:`center`},children:(0,U.jsx)(s,{children:`Create report`})})]})},"button-right-alignment-contained":{do:(0,U.jsx)(`div`,{style:{...G.demoRail,display:`flex`,justifyContent:`flex-end`},children:(0,U.jsx)(s,{children:`Save changes`})}),dont:(0,U.jsx)(`div`,{style:{width:`100%`,display:`flex`,justifyContent:`flex-end`,paddingTop:`var(--base-spacing-24)`},children:(0,U.jsx)(s,{children:`Save changes`})})},"button-touch-target-size":{do:(0,U.jsx)(a,{icon:`edit`,label:`Edit item`}),dont:(0,U.jsx)(s,{className:`a1-rule-demo-small-button`,icon:`edit`,"aria-label":`Edit item`})},"button-clear-states":{do:(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(s,{children:`Default`}),(0,U.jsx)(s,{className:`a1-rule-demo-focus`,children:`Focus`}),(0,U.jsx)(s,{disabled:!0,children:`Disabled`}),(0,U.jsx)(s,{icon:`sync`,children:`Saving...`})]}),dont:(0,U.jsx)(s,{className:`a1-rule-demo-no-state`,disabled:!0,children:`Save`})},"button-visible-focus":{do:(0,U.jsx)(s,{className:`a1-rule-demo-focus`,children:`Save changes`}),dont:(0,U.jsx)(s,{className:`a1-rule-demo-no-focus`,children:`Save changes`})},"button-disabled-explanation":{do:(0,U.jsxs)(`div`,{style:G.demoColumn,children:[(0,U.jsx)(s,{disabled:!0,children:`Create account`}),(0,U.jsx)(`p`,{style:G.demoText,children:`Add a valid email address to continue.`})]}),dont:(0,U.jsx)(s,{disabled:!0,children:`Create account`})},"button-loading-prevents-duplicates":{do:(0,U.jsx)(s,{disabled:!0,icon:`sync`,children:`Saving...`}),dont:(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(s,{children:`Save`}),(0,U.jsx)(s,{children:`Save`})]})},"button-icon-accessible-label":{do:(0,U.jsx)(a,{icon:`close`,label:`Close dialog`}),dont:(0,U.jsx)(s,{icon:`close`,"aria-hidden":`true`})},"button-vs-link-usage":{do:(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(s,{children:`Save settings`}),(0,U.jsx)(d,{href:`#`,children:`View documentation`})]}),dont:(0,U.jsx)(s,{as:`a`,href:`#`,children:`Documentation`})},"button-limited-variant-set":{do:(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(s,{children:`Primary`}),(0,U.jsx)(s,{variant:`secondary`,children:`Secondary`}),(0,U.jsx)(s,{variant:`tertiary`,children:`Tertiary`})]}),dont:(0,U.jsx)(`div`,{style:G.demoRow,children:(0,U.jsx)(s,{className:`a1-rule-demo-one-off`,children:`Special screen button`})})}}[e.id];return t?(0,U.jsxs)(`div`,{style:G.examples,children:[(0,U.jsx)(`style`,{children:`
        ...
        `}),(0,U.jsxs)(`div`,{style:G.example,children:[(0,U.jsx)(I,{type:`do`}),t.do]}),(0,U.jsxs)(`div`,{style:G.example,children:[(0,U.jsx)(I,{type:`dont`}),t.dont]})]}):null}function B({rule:e}){let t={"button-clear-action-label":{do:(0,U.jsx)(a,{icon:`delete`,label:`Delete project`}),dont:(0,U.jsx)(a,{icon:`delete`,label:`Delete`})},"button-visual-hierarchy":{do:(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(a,{icon:`settings`,label:`Settings`,variant:`secondary`}),(0,U.jsx)(a,{icon:`more_vert`,label:`More options`})]}),dont:(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(a,{icon:`settings`,label:`Settings`,variant:`secondary`}),(0,U.jsx)(a,{icon:`delete`,label:`Delete`,variant:`secondary`}),(0,U.jsx)(a,{icon:`more_vert`,label:`More options`,variant:`secondary`})]})},"button-not-color-alone":{do:(0,U.jsx)(a,{icon:`delete`,label:`Delete project`,variant:`destructive`}),dont:(0,U.jsx)(a,{icon:`more_vert`,label:`More options`,variant:`destructive`})},"button-destructive-clarity":{do:(0,U.jsx)(a,{icon:`delete`,label:`Delete project`,variant:`destructive`}),dont:(0,U.jsx)(a,{icon:`delete`,label:`Confirm`,variant:`destructive`})},"button-appropriate-visual-weight":{do:(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(a,{icon:`edit`,label:`Edit item`,variant:`secondary`}),(0,U.jsx)(a,{icon:`delete`,label:`Delete item`})]}),dont:(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(a,{icon:`delete`,label:`Delete item`,variant:`secondary`}),(0,U.jsx)(a,{icon:`edit`,label:`Edit item`})]})},"button-short-specific-labels":{do:(0,U.jsx)(a,{icon:`download`,label:`Download report`}),dont:(0,U.jsx)(a,{icon:`download`,label:`Click here to download the full monthly performance report`})},"button-verb-first-labels":{do:(0,U.jsx)(a,{icon:`edit`,label:`Edit profile`}),dont:(0,U.jsx)(a,{icon:`person`,label:`Profile`})},"button-consistent-placement":{do:(0,U.jsxs)(`div`,{style:G.demoColumn,children:[(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(a,{icon:`edit`,label:`Edit item`}),(0,U.jsx)(a,{icon:`delete`,label:`Delete item`})]}),(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(a,{icon:`edit`,label:`Edit member`}),(0,U.jsx)(a,{icon:`delete`,label:`Delete member`})]})]}),dont:(0,U.jsxs)(`div`,{style:G.demoColumn,children:[(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(a,{icon:`edit`,label:`Edit item`}),(0,U.jsx)(a,{icon:`delete`,label:`Delete item`})]}),(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(a,{icon:`delete`,label:`Delete member`}),(0,U.jsx)(a,{icon:`edit`,label:`Edit member`})]})]})},"button-align-with-content":{do:(0,U.jsxs)(`div`,{style:G.demoColumn,children:[(0,U.jsx)(`p`,{style:G.demoText,children:`Project details`}),(0,U.jsx)(a,{icon:`edit`,label:`Edit project`})]}),dont:(0,U.jsxs)(`div`,{style:{...G.demoRail,display:`flex`,flexDirection:`column`,alignItems:`center`,gap:`var(--base-spacing-8)`},children:[(0,U.jsx)(`p`,{style:{...G.demoText,alignSelf:`stretch`},children:`Project details`}),(0,U.jsx)(a,{icon:`edit`,label:`Edit project`})]})},"button-center-alignment-context":{do:(0,U.jsxs)(`div`,{style:{...G.demoColumn,alignItems:`center`,textAlign:`center`},children:[(0,U.jsx)(`p`,{style:G.demoText,children:`No reports yet`}),(0,U.jsx)(a,{icon:`add`,label:`Create report`,variant:`secondary`})]}),dont:(0,U.jsxs)(`div`,{style:G.demoColumn,children:[(0,U.jsx)(`p`,{style:G.demoText,children:`Reports`}),(0,U.jsx)(`div`,{style:{...G.demoRail,display:`flex`,justifyContent:`center`},children:(0,U.jsx)(a,{icon:`add`,label:`Create report`,variant:`secondary`})})]})},"button-right-alignment-contained":{do:(0,U.jsx)(`div`,{style:{...G.demoRail,display:`flex`,justifyContent:`flex-end`},children:(0,U.jsx)(a,{icon:`save`,label:`Save changes`,variant:`secondary`})}),dont:(0,U.jsx)(`div`,{style:{width:`100%`,display:`flex`,justifyContent:`flex-end`,paddingTop:`var(--base-spacing-24)`},children:(0,U.jsx)(a,{icon:`save`,label:`Save changes`,variant:`secondary`})})},"button-touch-target-size":{do:(0,U.jsx)(a,{icon:`edit`,label:`Edit item`}),dont:(0,U.jsx)(a,{icon:`edit`,label:`Edit item`,className:`a1-rule-demo-small-icon-button`})},"button-clear-states":{do:(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(a,{icon:`edit`,label:`Edit item`}),(0,U.jsx)(a,{icon:`edit`,label:`Focused edit item`,className:`a1-rule-demo-icon-focus`}),(0,U.jsx)(a,{icon:`edit`,label:`Edit item unavailable`,disabled:!0})]}),dont:(0,U.jsx)(a,{icon:`edit`,label:`Edit item unavailable`,disabled:!0,className:`a1-rule-demo-icon-no-state`})},"button-visible-focus":{do:(0,U.jsx)(a,{icon:`edit`,label:`Edit item`,className:`a1-rule-demo-icon-focus`}),dont:(0,U.jsx)(a,{icon:`edit`,label:`Edit item`,className:`a1-rule-demo-icon-no-focus`})},"button-disabled-explanation":{do:(0,U.jsxs)(`div`,{style:G.demoColumn,children:[(0,U.jsx)(a,{icon:`send`,label:`Send invitation`,disabled:!0}),(0,U.jsx)(`p`,{style:G.demoText,children:`Add an email address to send an invitation.`})]}),dont:(0,U.jsx)(a,{icon:`send`,label:`Send invitation`,disabled:!0})},"button-loading-prevents-duplicates":{do:(0,U.jsx)(a,{icon:`sync`,label:`Saving changes`,disabled:!0}),dont:(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(a,{icon:`save`,label:`Save changes`}),(0,U.jsx)(a,{icon:`save`,label:`Save changes`})]})},"button-icon-accessible-label":{do:(0,U.jsx)(a,{icon:`close`,label:`Close dialog`}),dont:(0,U.jsx)(`button`,{className:`a1-icon-button a1-icon-button--tertiary`,type:`button`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`close`})})},"button-vs-link-usage":{do:(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(a,{icon:`settings`,label:`Open settings`}),(0,U.jsx)(d,{href:`#`,icon:`open_in_new`,iconPosition:`end`,children:`Docs`})]}),dont:(0,U.jsx)(`a`,{className:`a1-icon-button a1-icon-button--tertiary`,href:`#`,children:(0,U.jsx)(`span`,{className:`material-symbols-outlined`,children:`docs`})})},"button-limited-variant-set":{do:(0,U.jsxs)(`div`,{style:G.demoRow,children:[(0,U.jsx)(a,{icon:`settings`,label:`Settings`}),(0,U.jsx)(a,{icon:`settings`,label:`Settings`,variant:`secondary`})]}),dont:(0,U.jsx)(a,{icon:`settings`,label:`Settings`,className:`a1-rule-demo-one-off-icon-button`})}}[e.id];return t?(0,U.jsxs)(`div`,{style:G.examples,children:[(0,U.jsx)(`style`,{children:`
        ...
        `}),(0,U.jsxs)(`div`,{style:G.example,children:[(0,U.jsx)(I,{type:`do`}),t.do]}),(0,U.jsxs)(`div`,{style:G.example,children:[(0,U.jsx)(I,{type:`dont`}),t.dont]})]}):null}function V({componentName:e,title:t,source:n}){let[r,i]=(0,H.useState)(`all`),a=K[e]??[],o=Array.from(new Set(a.flatMap(e=>e.applies_to??[]))).sort(),s=o.reduce((e,t)=>(e[t]=a.filter(e=>e.applies_to?.includes(t)).length,e),{}),c=r===`all`?a:a.filter(e=>e.applies_to?.includes(r));return(0,U.jsxs)(`div`,{style:G.page,children:[(0,U.jsxs)(`section`,{style:G.intro,children:[(0,U.jsx)(l,{as:`h1`,type:`display`,size:`xl`,children:t}),(0,U.jsxs)(h,{color:`muted`,children:[`Component rules from `,n,`. Rules can still identify multiple components when a rule spans them.`]})]}),(0,U.jsxs)(`section`,{style:G.group,children:[(0,U.jsxs)(`div`,{style:G.filter,"aria-label":`${t} tag filter`,children:[(0,U.jsx)(h,{size:`sm`,color:`muted`,children:`Filter by tag`}),(0,U.jsx)(`div`,{style:G.filterList,children:[`all`,...o].map(e=>{let t=r===e;return(0,U.jsx)(`button`,{type:`button`,style:{...G.filterButton,...t?G.filterButtonActive:{}},"aria-pressed":t,onClick:()=>i(e),children:e===`all`?`All (${a.length})`:`${e} (${s[e]})`},e)})})]}),(0,U.jsxs)(`div`,{style:G.ruleList,children:[c.map(t=>(0,U.jsxs)(`article`,{style:G.rule,children:[(0,U.jsx)(l,{as:`h2`,size:`xs`,children:t.id}),(0,U.jsx)(h,{children:t.requirement}),(0,U.jsx)(F,{rule:t,componentName:e}),(0,U.jsxs)(`div`,{style:G.meta,children:[t.components.length>1&&(0,U.jsxs)(`span`,{style:G.tag,children:[`components: `,t.components.join(`, `)]}),t.applies_to?.map(e=>(0,U.jsx)(`span`,{style:G.tag,children:e},e))]})]},`${t.filePath}-${t.id}`)),c.length===0&&(0,U.jsx)(h,{color:`muted`,children:`No rules match this tag.`})]})]})]})}var H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{_(),y(),x(),C(),T(),D(),k(),H=t(n(),1),o(),c(),i(),u(),f(),m(),U=r(),W=Object.assign({"../../../../system/rules/button.yaml":g,"../../../../system/rules/card.yaml":v,"../../../../system/rules/message-badge.yaml":b,"../../../../system/rules/motion.yaml":S,"../../../../system/rules/page-layout.yaml":w,"../../../../system/rules/side-nav.yaml":E,"../../../../system/rules/system.yaml":O}),G={page:{width:`min(960px, calc(100vw - 48px))`,display:`flex`,flexDirection:`column`,gap:`var(--base-spacing-32)`},intro:{maxWidth:`680px`,display:`flex`,flexDirection:`column`,gap:`var(--base-spacing-8)`},group:{display:`flex`,flexDirection:`column`,gap:`var(--base-spacing-16)`},ruleList:{display:`grid`,gap:`var(--base-spacing-12)`},filter:{display:`flex`,flexDirection:`column`,gap:`var(--base-spacing-8)`},filterList:{display:`flex`,flexWrap:`wrap`,gap:`var(--base-spacing-8)`},filterButton:{appearance:`none`,border:`1px solid var(--semantic-color-border-subtle)`,borderRadius:`var(--base-radius-control)`,background:`var(--semantic-color-surface-page)`,color:`var(--semantic-color-text-muted)`,cursor:`pointer`,fontFamily:`var(--component-paragraph-font-family)`,fontSize:`var(--semantic-font-size-body-sm)`,padding:`var(--base-spacing-4) var(--base-spacing-8)`},filterButtonActive:{background:`var(--semantic-color-action-background)`,borderColor:`var(--semantic-color-action-background)`,color:`var(--semantic-color-action-foreground)`},rule:{padding:`var(--base-spacing-20)`,border:`1px solid var(--semantic-color-border-subtle)`,borderRadius:`var(--base-radius-control)`,background:`var(--semantic-color-surface-panel)`},meta:{display:`flex`,flexWrap:`wrap`,gap:`var(--base-spacing-8)`,marginTop:`var(--base-spacing-12)`},examples:{display:`grid`,gridTemplateColumns:`repeat(2, minmax(0, 1fr))`,gap:`var(--base-spacing-12)`,marginTop:`var(--base-spacing-16)`},example:{minWidth:0,padding:`var(--base-spacing-12)`,border:`1px solid var(--semantic-color-border-subtle)`,borderRadius:`var(--base-radius-control)`,background:`var(--semantic-color-surface-page)`},exampleLabelWrap:{display:`flex`,marginBottom:`var(--base-spacing-8)`},demoRow:{display:`flex`,alignItems:`center`,gap:`var(--base-spacing-8)`,flexWrap:`wrap`},demoColumn:{display:`flex`,flexDirection:`column`,alignItems:`flex-start`,gap:`var(--base-spacing-8)`},demoText:{margin:0,color:`var(--semantic-color-text-muted)`,fontFamily:`var(--component-paragraph-font-family)`,fontSize:`var(--semantic-font-size-body-sm)`},demoRail:{boxSizing:`border-box`,width:`100%`,padding:`var(--base-spacing-8)`,border:`1px dashed var(--semantic-color-border-default)`,borderRadius:`var(--base-radius-control)`},tag:{padding:`var(--base-spacing-4) var(--base-spacing-8)`,borderRadius:`var(--base-radius-control)`,background:`var(--semantic-color-surface-page)`,color:`var(--semantic-color-text-muted)`,fontFamily:`monospace`,fontSize:`var(--semantic-font-size-body-xs)`}},K=P(Object.entries(W).map(([e,t])=>A(t,e))),q={title:`Rules`,parameters:{layout:`centered`,controls:{disable:!0}}},J={name:`Badge`,render:()=>(0,U.jsx)(V,{componentName:`Badge`,title:`Badge Rules`,source:`system/rules/message-badge.yaml`})},Y={name:`System`,render:()=>(0,U.jsx)(V,{componentName:`System`,title:`System Rules`,source:`system/rules/system.yaml`})},X={name:`Heading`,render:()=>(0,U.jsx)(V,{componentName:`Heading`,title:`Heading Rules`,source:`system/rules/system.yaml`})},Z={name:`Icon Button`,render:()=>(0,U.jsx)(V,{componentName:`IconButton`,title:`Icon Button Rules`,source:`system/rules/button.yaml`})},Q={name:`Button`,render:()=>(0,U.jsx)(V,{componentName:`Button`,title:`Button Rules`,source:`system/rules/button.yaml`})},J.parameters={...J.parameters,docs:{...J.parameters?.docs,source:{originalSource:`{
  name: "Badge",
...
}`,...Q.parameters?.docs?.source}}},$=[`Badge`,`SystemRules`,`HeadingRules`,`IconButtonRules`,`ButtonRules`]}))();export{J as Badge,Q as ButtonRules,X as HeadingRules,Z as IconButtonRules,Y as SystemRules,$ as __namedExportsOrder,q as default};