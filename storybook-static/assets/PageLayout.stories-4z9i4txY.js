...
background extends edge-to-edge without a seam.`,...k.parameters?.docs?.description}}},A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`{
  ...
  render: () => <PageLayout stickyHeader viewportHeight header={<div style={{
    ...headerStyle,
    boxShadow: "var(--semantic-shadow-sm)"
  }}>
...
}`,...P.parameters?.docs?.source}}},F=[`HeaderAndFooter`,`WithSidebar`,`WithRightSideNav`,`WithAside`,`WithLeftAside`,`StickyHeader`,`ViewportHeightMainScroll`]}))();export{O as HeaderAndFooter,N as StickyHeader,P as ViewportHeightMainScroll,j as WithAside,M as WithLeftAside,A as WithRightSideNav,k as WithSidebar,F as __namedExportsOrder,S as default};